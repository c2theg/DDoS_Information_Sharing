...
print "\r\n\r\n\r\n"
#-----------------------------------------------------------------------------------------------------------------------------------------------------
# Command line argument help info 
...
varAppendText = "\n------------------ DDoS Collector v" + appVersion + " READY! (" + appTime + ") Listening on " + str(varSyslogProto) + " " + str(varSyslogPort) + " ------------------\n"
print varAppendText
        ...
        if dataStr.find(varlocal_syslog_trigger_on) == -1:
            ...
            if '.py' in varSourceCollector:
                if pathConfigFile is not None:
                    varCommand = "python " + appCurrentPath + "/" + varSourceCollector + " -c  " + pathConfigFile +  " -a " + varAlertID
                    print "This is our varCommand:", varCommand
                else:
